...
class FractionallySizedBoxWidgets extends StatefulWidget {
  const FractionallySizedBoxWidgets({super.key});

  @override
  State<FractionallySizedBoxWidgets> createState() => _FractionallySizedBoxWidgetsState();
}

class _FractionallySizedBoxWidgetsState extends State<FractionallySizedBoxWidgets> {
  @override
